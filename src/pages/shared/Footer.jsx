            ...
            <footer>
                ...
                <div className=" h-4/5 relative bg-center" style={{ backgroundImage: 'url(https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)' }}>
                    ...
                    <div className="flex justify-between text-white ">
                        ...
                        {/* Right side */}
                        <div className="relative text-white w-full mt-32 my-16">
                ...
                <div className="flex justify-between bg-zinc-700 py-5">
                    <p className="text-base text-white ml-10">@ Copyright 2017 All rights reserved - Designed by Tousif Nuhan</p>
                    <ul className="flex text-[#71b100] mr-10">
